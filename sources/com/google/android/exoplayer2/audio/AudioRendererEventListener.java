...
public interface AudioRendererEventListener {
    ...
    public static final class EventDispatcher {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda5
                    ...
                    public final void run() {
                        this.f$0.m105x5024e2cf(decoderCounters);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m105x5024e2cf(DecoderCounters decoderCounters) {
        ...
        public void decoderInitialized(final String str, final long j, final long j2) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m102x34ee4b45(str, j, j2);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m102x34ee4b45(String str, long j, long j2) {
        ...
        public void inputFormatChanged(final Format format, final DecoderReuseEvaluation decoderReuseEvaluation) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m106xd066461(format, decoderReuseEvaluation);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m106xd066461(Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
        ...
        /* synthetic */ void m107x4b664277(long j) {
        ...
        /* synthetic */ void m109x69131a3f(int i, long j, long j2) {
        ...
        /* synthetic */ void m103x97e584ca(String str) {
        ...
        public void disabled(final DecoderCounters decoderCounters) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.audio.AudioRendererEventListener$EventDispatcher$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m104xa9a48754(decoderCounters);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m104xa9a48754(DecoderCounters decoderCounters) {
            decoderCounters.ensureUpdated();
        ...
        /* synthetic */ void m108x9104d974(boolean z) {
        ...
        /* synthetic */ void m101xcf2a89af(Exception exc) {
        ...
        /* synthetic */ void m100x305f60bf(Exception exc) {
