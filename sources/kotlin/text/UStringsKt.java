...
public final class UStringsKt {
    ...
    public static final String m1616toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1618toStringolVBNx4(short s, int i) {
    ...
    public static final String m1617toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1615toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m399constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m316boximpl(UByte.m322constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m399constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m579boximpl(UShort.m585constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM399constructorimpl = UInt.m399constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM399constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM399constructorimpl2 = UInt.m399constructorimpl(i3 * iM399constructorimpl);
            int iM399constructorimpl3 = UInt.m399constructorimpl(UInt.m399constructorimpl(iDigitOf) + iM399constructorimpl2);
            if (Integer.compareUnsigned(iM399constructorimpl3, iM399constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM399constructorimpl3;
        }
        return UInt.m393boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM478constructorimpl = ULong.m478constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM478constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM478constructorimpl2 = ULong.m478constructorimpl(j * jM478constructorimpl);
            long jM478constructorimpl3 = ULong.m478constructorimpl(ULong.m478constructorimpl(((long) UInt.m399constructorimpl(iDigitOf)) & 4294967295L) + jM478constructorimpl2);
            if (Long.compareUnsigned(jM478constructorimpl3, jM478constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM478constructorimpl3;
        }
        return ULong.m472boximpl(j);
    }
}
