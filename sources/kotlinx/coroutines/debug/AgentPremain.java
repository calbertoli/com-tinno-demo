...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM304constructorimpl = Result.m304constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM304constructorimpl = Result.m304constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m310isFailureimpl(objM304constructorimpl) ? null : objM304constructorimpl);
        if (bool != null) {
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1833installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1833installSignalHandler$lambda1(Signal signal) {
