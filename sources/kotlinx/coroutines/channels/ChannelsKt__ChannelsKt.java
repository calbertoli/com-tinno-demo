...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM304constructorimpl = Result.m304constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM304constructorimpl = Result.m304constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1816boximpl(Result.m311isSuccessimpl(objM304constructorimpl) ? ChannelResult.INSTANCE.m1831successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1829closedJP2dKIU(Result.m307exceptionOrNullimpl(objM304constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1811trySendJP2dKIU = sendChannel.mo1811trySendJP2dKIU(e);
        if (objMo1811trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1826isSuccessimpl(sendChannel.mo1811trySendJP2dKIU(e))) {
            return;
        }
