...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1809receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1809receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1810tryReceivePtdJZtk() {
        return this._channel.mo1810tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo1811trySendJP2dKIU(E element) {
        return this._channel.mo1811trySendJP2dKIU(element);
    }
