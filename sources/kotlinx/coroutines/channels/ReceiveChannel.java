...
public interface ReceiveChannel<E> {
    ...
    Object mo1809receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1810tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1810tryReceivePtdJZtk = receiveChannel.mo1810tryReceivePtdJZtk();
            if (ChannelResult.m1826isSuccessimpl(objMo1810tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1822getOrThrowimpl(objMo1810tryReceivePtdJZtk);
            }
            Throwable thM1820exceptionOrNullimpl = ChannelResult.m1820exceptionOrNullimpl(objMo1810tryReceivePtdJZtk);
            if (thM1820exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1820exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1809receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
