...
public class StringsKt__IndentKt extends StringsKt__AppendableKt {
    ...
    public static final String replaceIndent(String str, String newIndent) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList4, new StringBuilder(length), (R.styleable.AppCompatTheme_windowMinWidthMajor & 2) != 0 ? ", " : "\n", (R.styleable.AppCompatTheme_windowMinWidthMajor & 4) != 0 ? "" : null, (R.styleable.AppCompatTheme_windowMinWidthMajor & 8) != 0 ? "" : null, (R.styleable.AppCompatTheme_windowMinWidthMajor & 16) != 0 ? -1 : 0, (R.styleable.AppCompatTheme_windowMinWidthMajor & 32) != 0 ? "..." : null, (R.styleable.AppCompatTheme_windowMinWidthMajor & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
    ...
    private static final String reindent$StringsKt__IndentKt(List<String> list, int i, Function1<? super String, String> function1, Function1<? super String, String> function12) {
        ...
        String string = ((StringBuilder) CollectionsKt.joinTo(arrayList, new StringBuilder(i), (R.styleable.AppCompatTheme_windowMinWidthMajor & 2) != 0 ? ", " : "\n", (R.styleable.AppCompatTheme_windowMinWidthMajor & 4) != 0 ? "" : null, (R.styleable.AppCompatTheme_windowMinWidthMajor & 8) != 0 ? "" : null, (R.styleable.AppCompatTheme_windowMinWidthMajor & 16) != 0 ? -1 : 0, (R.styleable.AppCompatTheme_windowMinWidthMajor & 32) != 0 ? "..." : null, (R.styleable.AppCompatTheme_windowMinWidthMajor & 64) != 0 ? null : null)).toString();
        Intrinsics.checkNotNullExpressionValue(string, "mapIndexedNotNull { inde…\"\\n\")\n        .toString()");
        return string;
    }
}
