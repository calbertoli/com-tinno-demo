...
public final class DurationKt {
    ...
    private static final long m1756timesmvk6XK0(int i, long j) {
        return Duration.m1668timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1755timeskIfJnKk(double d, long j) {
        return Duration.m1667timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1732getZEROUwyO8pc = Duration.INSTANCE.m1732getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1666plusLRDsOJo = Duration.m1666plusLRDsOJo(jM1732getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1732getZEROUwyO8pc = Duration.m1666plusLRDsOJo(jM1666plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM1732getZEROUwyO8pc = Duration.m1666plusLRDsOJo(jM1732getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1732getZEROUwyO8pc = Duration.INSTANCE.m1730getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1666plusLRDsOJo2 = Duration.m1666plusLRDsOJo(jM1732getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        String str6 = str4;
                        Intrinsics.checkNotNullExpressionValue(strSubstring7, str6);
                        jM1732getZEROUwyO8pc = Duration.m1666plusLRDsOJo(jM1666plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                        str4 = str6;
                    } else {
                        jM1732getZEROUwyO8pc = Duration.m1666plusLRDsOJo(jM1732getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m1682unaryMinusUwyO8pc(jM1732getZEROUwyO8pc) : jM1732getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1630constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1630constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1630constructorimpl((j << 1) + ((long) i));
    }
