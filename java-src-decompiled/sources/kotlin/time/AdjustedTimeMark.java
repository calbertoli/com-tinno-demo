...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1620minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1766minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1619elapsedNowUwyO8pc() {
        return Duration.m1665minusLRDsOJo(this.mark.mo1619elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1622plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1666plusLRDsOJo(this.adjustment, duration), null);
    }
}
