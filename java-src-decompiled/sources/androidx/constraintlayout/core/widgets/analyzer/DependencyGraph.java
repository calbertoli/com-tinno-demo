...
public class DependencyGraph {
    ...
    public boolean directMeasureWithOrientation(boolean z, int i) {
        ...
        for (WidgetRun widgetRun2 : this.mRuns) {
            if (widgetRun2.orientation == i && (z2 || widgetRun2.mWidget != this.mWidgetcontainer)) {
                if (!widgetRun2.start.resolved || !widgetRun2.end.resolved || (!(widgetRun2 instanceof ChainRun) && !widgetRun2.mDimension.resolved)) {
                    z3 = false;
                    break;
                }
            }
