        ...
        while (true) {
            ...
            while (i16 < i3) {
                if (motionPathsArr[i16].hasCustomData(str10)) {
                    if (dArr5 == null) {
                        dArr4 = new double[i3];
                        dArr5 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i3, motionPathsArr[i16].getCustomDataCount(str10));
                    }
                    dArr = dArr2;
                    dArr4[i17] = motionPathsArr[i16].mTime;
                    motionPathsArr[i16].getCustomData(str10, dArr5[i17], 0);
                    i17++;
                } else {
                    dArr = dArr2;
                }
