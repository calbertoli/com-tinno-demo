...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1811trySendJP2dKIU(E element) {
        ...
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return closedForSend == null ? ChannelResult.INSTANCE.m1830failurePtdJZtk() : ChannelResult.INSTANCE.m1829closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1829closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m304constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m304constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1855remove()) {
                receive.helpRemove();
            } else {
                objM1847constructorimpl$default = InlineList.m1852plusFjFbRPM(objM1847constructorimpl$default, receive);
            }
        }
        if (objM1847constructorimpl$default != null) {
            if (!(objM1847constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1847constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1847constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1847constructorimpl$default;
    ...
    */
    public final java.lang.Object sendSuspend(E r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L61:
            ...
            java.lang.Object r5 = kotlin.Result.m304constructorimpl(r5)
            r1.resumeWith(r5)
            goto L86
        L77:
