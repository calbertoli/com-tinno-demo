...
public interface SendChannel<E> {
    ...
    Object mo1811trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1826isSuccessimpl(objMo1811trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1820exceptionOrNullimpl = ChannelResult.m1820exceptionOrNullimpl(objMo1811trySendJP2dKIU);
