...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM304constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM304constructorimpl = Result.m304constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM304constructorimpl = Result.m304constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m307exceptionOrNullimpl(objM304constructorimpl) == null) {
            obj2 = objM304constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM304constructorimpl2 = Result.m304constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM304constructorimpl2 = Result.m304constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m307exceptionOrNullimpl(objM304constructorimpl2) == null) {
            obj = objM304constructorimpl2;
        }
