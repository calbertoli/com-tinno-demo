...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1857scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1793delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1794toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1794toDelayMillisLRDsOJo(long j) {
        if (Duration.m1629compareToLRDsOJo(j, Duration.INSTANCE.m1732getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1648getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
