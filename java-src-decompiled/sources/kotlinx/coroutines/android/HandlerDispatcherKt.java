...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM304constructorimpl = Result.m304constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM304constructorimpl = Result.m304constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m310isFailureimpl(objM304constructorimpl) ? null : objM304constructorimpl);
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1807postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1807postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1856dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
