...
public interface Delay {
    ...
    void mo1857scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation);
    ...
    public static final class DefaultImpls {
        ...
        public static Object delay(Delay delay, long j, Continuation<? super Unit> continuation) {
            ...
            delay.mo1857scheduleResumeAfterDelay(j, cancellableContinuationImpl);
